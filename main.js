const githubData = [
 ...
 /* Your task it to use your knowledge of accessing property values and array indices to output 
 the commit message for the push event with an id of 8030403992. */
  ...
  let index = githubData.find(checkId)
  console.log(" this one gets if there is match Id number", index)
  console.log("this one gets the commits in the same ID", index.payload.commits[0].message)
